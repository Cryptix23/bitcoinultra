...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BitcoinUltra-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("BitcoinUltra-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitcoinUltra " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("BitcoinUltra-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BitcoinUltra-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BitcoinUltra-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BitcoinUltra-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitcoinUltra is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BitcoinUltra-start");
